    ...
    <template #default="{ data }">
      <div class="container max-w-lg pb-16">
        <div class="grid grid-cols-1 gap-10">
          <ContactForm
            title="Let's Start Planning Your Amazing Outing!"
            description="Ready for your perfect HR-driven outing? Share some details, and our specialist will contact you soon to discuss your ideas!"
            submitLabel="Submit"
