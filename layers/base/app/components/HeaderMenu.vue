  ...
  <DialogRoot v-model:open="isOpen">
    ...
    <DialogPortal>
      ...
      >
        ...
        <div
          class="xs:px-4 absolute inset-x-0 bottom-0 flex h-16 w-full items-center justify-center px-2 pb-4 sm:px-8"
        >
          <DialogClose as-child>
            <NuxtLink
              ...
              @click="$scrollToTopIfCurrentPageIs(localePath('/contact'))"
              v-ripple
              >{{ $t("ui.contactUs") }}</NuxtLink
            >
          </DialogClose>
        </div>
      </DialogContent>
